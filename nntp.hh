...
#define INF_DATE        111     /* Date of NNTP server is returned */
...
#define OK_XOVER        224     /* Group overview follows */
...
#define	NNTP_STRLEN	5120    // 512 is not correct (see sometimes xref-headers) !
